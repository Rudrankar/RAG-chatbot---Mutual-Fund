...
- **Document Acquisition:** Collect and parse information from the Groww URLs above, supplemented by official public sources (Scheme factsheets, KIM, SID, FAQ, AMFI/SEBI pages).
...
- **Length Limit:** Each response is limited to a maximum of 3 sentences.
- **Citations:** Each response must include exactly one citation link.
- **Footer:** Each response must include a footer: `Last updated from sources: <date>`
